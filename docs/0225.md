...
![ADO Net Webform Example 1](../Images/28010dd97a2a73fe6addfb2aa3312ff6.png)

填写表格并提交数据。

![ADO Net Webform Example 2](../Images/a56c76e10d95a3f564ee66a501a3d7f8.png)

提交后，它从 SQL Server 数据库中存储和检索数据。

![ADO Net Webform Example 3](../Images/b13bfa9a6e759f5440a43ebd68f4586a.png)