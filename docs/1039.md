...
![MSpowerpoint How to format chart or chart data 1](../Images/343c651fcb31d5704c47e2bd192a8643.png)

“布局”选项卡包含六个组；当前选择、插入、标签、轴、背景和分析。

**见图:**

![MSpowerpoint How to format chart or chart data 2](../Images/645d280a9d369f51bd6844bc610e78bc.png)

“格式”选项卡包含五个组；当前选择、形状样式、艺术字样式、排列和大小。

**见图:**

![MSpowerpoint How to format chart or chart data 3](../Images/f0fc0d3f04818d6a3da0ac7f6badeb1e.png)